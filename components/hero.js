    ...
    <>
      ...
      <Container className="flex flex-wrap w-11/12 mt-10 lg:mt-0 mb-4">
        <div className="relative flex items-center w-full lg:w-1/2 ">
          <div className="absolute top-0 -left-4 w-72 h-72 bg-purple-300 mix-blend-multiply filter blur-xl opacity-50 rounded-full animate-blob mt-10 z-0"></div>
          <div className="absolute top-0 -right-4 w-72 h-72 bg-yellow-300 mix-blend-multiply filter blur-xl opacity-50 rounded-full animate-blob animation-delay-2000 mt-20 z-0"></div>
          <div className="absolute top-0 -bottom-8 w-72 h-72 bg-pink-300 mix-blend-multiply filter blur-xl opacity-50 rounded-full animate-blob animation-delay-4000 mt-36 z-0"></div>
