...
import wa from "../public/img/Whatsapp.png";
import email from "../public/img/Outlook.png";
import telp from "../public/img/Viber.png";

export default function Footer() {
  //const navigation = ["Tentang", "Kontak", "Pricing", "Company", "Blog"];
  const navigation = ["Tentang"];
